  ...
  return (
    <>
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetTrigger
          className="md:hidden inline-flex items-center justify-center h-9 w-9 rounded-md text-foreground hover:bg-accent transition-colors touch-manipulation motion-reduce:transition-none"
